...
function Footer() {
	var s = "";
	s = s + "<!--start output from Footer().-->";
	var d = new Date();
	s = s + "<div class='container'>";
	s = s + "<div class='d-flex justify-content-md-between flex-column flex-md-column flex-lg-row'>";
	s = s + "<div class='text-lg-left footerInfo'>";
	s = s + "<div>ELECTIONS DEPARTMENT SINGAPORE</div><br/>";

	s = s + "<div class='d-flex justify-content-center justify-content-lg-start flex-md-row flex-column flex-lg-wrap col-lg-11 pl-lg-0'>";
	s = s + "<div class='footerPadRight'><a href='https://tech.gov.sg/report_vulnerability.html' target='_blank'>Report Vulnerability</a></div>";

	s = s + "<div class='footerPadRight'><a href='privacy.html'>Privacy Statement</a></div>";

	s = s + "<div class='footerPadRight'><a href='terms.html'>Terms of Use</a></div>";

	s = s + "<div class='footerPadRight'><a href='https://app.eservice.eld.gov.sg/voter/eldWebsiteePollForm.aspx' target='_blank'><nobr>Rate this Service</nobr></a></div>";

	s = s + "<div class='footerPadRight pt-lg-2'><a href='sitemap.html'>Sitemap</a></div>";

	s = s + "<div class='footerPadRight pt-lg-2'><a href='links.html'>Links</a></div>";
	s = s + "</div>";
	s = s + "</div>";

	s = s + "<div class='text-lg-right footerInfo footerImg'>";
	s = s + "<div>";
	s = s + "<img src='images/SQC.svg' alt='Singapore Quality Class Logo' title='Singapore Quality Class Logo' style='width: 140px; margin-right: 15px;'><br/>";
	s = s + "<span>&copy;" + d.getFullYear() + " Government of Singapore</span>";
	s = s + "<br/>";
	s = s + "<div style='margin-right: 0px;'> Last updated </span><span id='spanLastUpdated'></div>";
	s = s + "</div>";
	s = s + "</div>";

	s = s + "</div>";
	s = s + "</div>";
	s = s + "<!--end output from Footer()-->";
	document.getElementById("divFooter").innerHTML = s;
}
...
function doPageActions(subj, bod) {
	var s = "";
	s = s + "<ul>";
	s = s + "<li class='plusFont'><a href='javascript:increaseFontSize();' alt='Increase Font Size' title='Increase Font Size'></a></li>";
	s = s + "<li class='minusFont'><a href='javascript:decreaseFontSize();' alt='Decrease Font Size' title='Decrease Font Size'></a></li>";
	s = s + "<li class='sendEmail'><a href='mailto:?Subject=" + subj + "&Body=https://www.eld.gov.sg/" + bod + "' alt='Email' title='Email'></a></li>";
	s = s + "<li class='sendPrint'><a href='#printicon' onclick='_doPostBack();' id='printicon' alt='Print' title='Print'></a></li>";
	s = s + "</ul>";

	document.getElementById("divPageActionHeader").innerHTML = s;
	document.getElementById("divPageAction").innerHTML = s;
}